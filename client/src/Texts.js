    ...
    return(
        <div className="chat-window">
            ...
            <div className="chat-footer">
                <input type="text" value={currenttext} placeholder="Omg, I love this song!" onChange = {(event) => {setcurrenttext(event.target.value)}} onKeyPress={(event) => {event.key === "Enter" && sendtext();}}/>
